    ...
    <div className={styles.container}>
      ...
      <div className={styles.textContainer}>
        ...
        <div className={styles.content}>
          ...
          nostrum expedita dolores eveniet quisquam, numquam minima excepturi
          corrupti corporis, assumenda enim tempora modi blanditiis hic nihil
          facilis nemo consectetur.
        </div>
      </div>
    </div>
  );
